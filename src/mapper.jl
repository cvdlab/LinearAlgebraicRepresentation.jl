...
julia>  LARVIEW.view(LARLIB.helicoid()())
```
"""
...
julia> LARVIEW.view(LARLIB.ring()())
```
"""
...
julia> LARVIEW.view(LARLIB.cylinder()())
```
"""
...
julia> LARVIEW.view(LARLIB.sphere()())
```
"""
...
julia> LARVIEW.view(LARLIB.toroidal()())
```
"""
...
julia> LARVIEW.view(LARLIB.crown()())
```
"""
...
julia> LARVIEW.view(LARLIB.struct2lar(assemby))
```
"""
...
julia> LARVIEW.view(LARLIB.ball()())
```
"""
...
julia> LARVIEW.view(LARLIB.hollowCyl()())
```
"""
